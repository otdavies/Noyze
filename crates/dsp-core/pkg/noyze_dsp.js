 ...
 */
export function process_chain(input_l, input_r, ref_l, sample_rate, config_json) {
    ...
    const ptr2 = passArrayF32ToWasm0(ref_l, wasm.__wbindgen_malloc);
    const len2 = WASM_VECTOR_LEN;
    const ptr3 = passStringToWasm0(config_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len3 = WASM_VECTOR_LEN;
    const ret = wasm.process_chain(ptr0, len0, ptr1, len1, ptr2, len2, sample_rate, ptr3, len3);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('noyze_dsp_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
